...
const AdminUpdateBusiness = ({ visible, onClose, businessInfo, setBusinessInfo }) => {
                ...
                <Form>
                    ...
                    <FormGroup>
                        ...
                        <Input type="email" id="email" value={formData.email}
                            onChange={handleChange} placeholder="Enter business email" />
                    </FormGroup>
                    <FormGroup>
                        <Label for="hours">Hours</Label>
                        <Input type="text" id="hours" value={formData.hours}
                            onChange={handleChange} placeholder="Enter business hours" />
                    </FormGroup>
                    <FormGroup>
                        <Label for="address">Address</Label>
                        <Input type="text" id="address" value={formData.address}
                            onChange={handleChange} placeholder="Enter business address" />
                    </FormGroup>
                </Form>
            </ModalBody>
            <ModalFooter>
