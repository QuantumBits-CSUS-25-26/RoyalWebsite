...
const Management = () => {
  ...
  console.log('Management page: storedUserRaw', storedUserRaw);
  console.log('Management page: storedUser', storedUser);

  const isAuthorized = (user) => {
    console.log('Management page: isAuthorized check for user', user);
